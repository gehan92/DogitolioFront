...
function AuthInner() {
  ...
  async function handleForgot(e) {
    ...
    try {
      ...
      if (error) setError(error.message)
      else setSuccess('Reset link sent! Check your email and click the link to set a new password.')
    } finally {
      setBusy(false)
    }
  }
    ...
    <div className="min-h-screen flex" style={{ background: 'var(--c-bg)' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[420px] shrink-0 p-10 relative overflow-hidden"
        ...
        <div className="relative z-10">
          <img src="/logo.svg" alt="MealHere" className="w-12 h-12 rounded-2xl mb-3" />
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden text-center mb-8">
            <img src="/logo.svg" alt="MealHere" className="w-14 h-14 mx-auto rounded-2xl mb-3" />
          ...
          <p className="text-gray-400 text-sm mb-7">
            {tab === 'signin' ? "Sign in to rate and review food places."
              : tab === 'signup' ? "Join to discover menus across Sri Lanka."
          ...
          {tab === 'forgot' ? (
            <form onSubmit={handleForgot} className="space-y-3 mb-5">
