...
const stats = [
  ...
  { value: '4',    label: 'Venue Categories' },
]
      ...
      <main>
        ...
        <section className="bg-[#080808] py-20 px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-display text-3xl md:text-4xl font-black text-white mb-4">Ready to explore?</h2>
            <p className="text-white/60 mb-8 leading-relaxed">Find the best food menus near you — from hotels to snack bars, all across Sri Lanka.</p>
