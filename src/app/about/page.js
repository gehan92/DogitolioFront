...
export default async function AboutPage() {
  ...
  // ── Hero
  const headline    = cms.headline    || 'About Digitolio'
  const subheadline = cms.subheadline || "We built Digitolio to solve a simple problem — finding food menus across Sri Lanka was hard. We made it easy."
  ...
  const storyP1    = cms.storyP1    || "Digitolio started with a simple question: \"Where can I find the menu before I go?\" We built the answer — a single platform where anyone can discover and explore food menus from hotels, restaurants, food shops and snack bars across every province in Sri Lanka."
  const storyP2    = cms.storyP2    || "Whether you're a tourist looking for a good meal, a local finding a new favourite spot, or a business owner wanting to showcase your menu — Digitolio is built for you."
