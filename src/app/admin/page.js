    ...
    <>
      ...
      <div className="flex min-h-[calc(100vh-66px)]">
        ...
        <div className="flex-1 min-w-0 flex flex-col">
          ...
          {/* Mobile top bar */}
          <div className="lg:hidden sticky top-[66px] z-30 flex items-center gap-3 px-4 py-3 bg-white border-b border-gray-100"
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          {!r.is_approved ? (
                            ...
                            <button onClick={() => approveReview(r.id, false)}
                              className="p-1.5 rounded-lg hover:bg-amber-50 text-amber-600 transition-colors" title="Unapprove">
                              <X size={15} />
                            </button>
                          )}
                    ...
                    <div className="card p-5">
                      ...
                      <form onSubmit={miSave} className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 pt-1">
                          ...
                          {miEditId && (
                            <button type="button" onClick={miReset}
